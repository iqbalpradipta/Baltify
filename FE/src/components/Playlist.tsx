        ...
        <AccordionDetails>
          <Box>
            <Link
              ...
              to="/"
              underline="none"
              sx={{ gap: "30px", color: "white", fontSize: "18px" }}
            >
              <Stack direction="row" gap="45px" color="white">
                <FaPlus />
                <Box>Add Playlist</Box>
              </Stack>
            </Link>
          </Box>
        </AccordionDetails>
          ...
          <AccordionDetails>
            <Box>
              <Link
                ...
                sx={{ gap: "30px", color: "white", fontSize: "18px" }}
              >
                <Stack direction="row" gap="30px" color="white">
                  <img
                    alt="REI SARAH"
                    ...
                    style={{ width: "10%", borderRadius: 6 }}
                  />
                  <Box sx={{ marginTop: 1 }}>Playlist Gacor</Box>
                </Stack>
              </Link>
            </Box>
          </AccordionDetails>
